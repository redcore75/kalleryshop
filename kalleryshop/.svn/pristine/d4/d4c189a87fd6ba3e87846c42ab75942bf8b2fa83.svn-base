	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-2" align="center">
				<a href="${pageContext.request.contextPath}/front/main/index.do"><button type="button" class="btn btn-default" style="width: 100%;"><spring:message code="common.wd.메인으로" /></button></a>					
			</div>
			<div class="col-md-5"></div>
		</div>
	</div>
