 ...
 * 
 * <p>
 * Description: Convenience methods for altering special characters related to
 * URLs, regular expressions, and HTML tags.
 * </p>
 * 
 * <p>
...
public final class EscapeChars {
	 ...
	 * {@link #forHTMLTag}), instead of just the start-of-tag and end-of-tag
	 * characters. In particular, the ampersand character is often escaped not
	 * once but <em>twice</em> : once when the original input occurs, and then a
	 * second time when the same item is retrieved from the database. This
	 * occurs because the ampersand is the only escaped character which appears
