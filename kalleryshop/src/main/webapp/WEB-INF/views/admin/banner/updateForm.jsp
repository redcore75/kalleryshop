...
<body>
	...
	<div class="content">
  		<form:form modelAttribute="vw_banner" class="form-signin" id="registForm" name="registForm" method="post" action="update.do" enctype="multipart/form-data">
  			<cf:token/>
      		<div class="box box-default">
        		<div class="box-header with-border">
          			<h3 class="box-title"><spring:message code="common.wd.배너관리" /> > <spring:message code="common.wd.배너상세수정" /></h3>
        		</div>
        		<!-- /.box-header -->
        		<div class="box-body">
					<!-- /.row -->
          			<div class="row">
            			<div class="col-md-12">
              				<div class="form-group">
								<div class="row">
									<div class="col-md-1"><label><spring:message code="common.wd.배너상세번호" /></label></div>
									<div class="col-md-11">
										<form:errors path="banner_seq" cssClass="text-red" element="div"/>
										<form:input path="banner_seq" type="text" class="form-control" maxlength="20" style="width: 100%;" readonly="true"/>
									</div>
								</div>
              				</div>
            			</div>
              				...
              				<div class="form-group">
								<div class="row">
									...
									<div class="col-md-11">
										...
										<c:if test="${(vw_banner.img_path != null) && (vw_banner.img_path != '')}">
											<img src="${pageContext.request.contextPath}/upload/${vw_banner.img_path}" width="100" height="100"/>
										</c:if>
									</div>
								</div>
              				</div>
