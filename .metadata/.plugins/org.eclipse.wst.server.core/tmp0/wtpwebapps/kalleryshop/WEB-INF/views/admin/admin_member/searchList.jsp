          			...
          			<div class="row">
            			<div class="col-md-6">
              				<div class="form-group">
								<div class="row">
									<div class="col-md-2"><label><spring:message code="common.wd.관리자아이디" /></label></div>
            			...
            			<div class="col-md-6">
	              			<div class="form-group">
								<div class="row">
									<div class="col-md-2"><label><spring:message code="common.wd.관리자명" /></label></div>
          		...
          		<div class="box">
            		...
            		<div class="box-body">
              			<table id="example2" class="table table-bordered table-hover">
                			<thead>
                				<tr>
                  					<th width="10%"><spring:message code="common.wd.관리자번호" /></th>
                  					<th width="10%"><spring:message code="common.wd.관리자등급" /></th>
                  					<th width="10%"><spring:message code="common.wd.관리자아이디" /></th>
                  					<th><spring:message code="common.wd.관리자명" /></th>
                  					<th><spring:message code="common.wd.이메일" /></th>
