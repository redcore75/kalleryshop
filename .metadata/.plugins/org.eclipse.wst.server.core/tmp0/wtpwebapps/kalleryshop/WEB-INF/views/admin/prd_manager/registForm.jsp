              				...
              				<div class="form-group">
								<div class="row">
									...
									<div class="col-md-10">
										...
										<cf:common_code_radio code_group_id="PRD_STATUS" tag_name="prd_status" tag_id="prd_status" tag_value="A"></cf:common_code_radio>
									</div>
								</div>
              				</div>
            			</div>
              				...
              				<div class="form-group">
								<div class="row">
									...
									<div class="col-md-10">
										...
										<cf:common_code_radio code_group_id="IS_OPT_USE" tag_name="is_opt_use" tag_id="is_opt_use" tag_value="N"></cf:common_code_radio>
									</div>
								</div>
              				</div>
            			</div>
