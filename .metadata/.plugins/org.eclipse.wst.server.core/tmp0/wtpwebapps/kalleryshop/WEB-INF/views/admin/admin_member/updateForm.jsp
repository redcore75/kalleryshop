  		...
  		<form:form modelAttribute="tbl_member" class="form-signin" id="updateForm" name="updateForm" method="post" action="update.do">
      		...
      		<div class="box box-default">
        		<div class="box-header with-border">
          			<h3 class="box-title"><spring:message code="common.wd.시스템관리" /> > <spring:message code="common.wd.관리자수정" /></h3>
        		</div>
        		<!-- /.box-header -->
        		<div class="box-body">
          			<div class="row">
					...
					<!-- /.row -->
          			<div class="row">
            			<div class="col-md-6">
              				<div class="form-group">
								<div class="row">
									<div class="col-md-2"><label><spring:message code="common.wd.관리자레벨" /></label></div>
									<div class="col-md-10">
										...
										<form:select path="member_level_seq" class="form-control" style="width: 100%;">
											...
											<form:option value="1"><spring:message code="common.wd.관리자" /></form:option>
										</form:select>
									</div>
								</div>
              				</div>
