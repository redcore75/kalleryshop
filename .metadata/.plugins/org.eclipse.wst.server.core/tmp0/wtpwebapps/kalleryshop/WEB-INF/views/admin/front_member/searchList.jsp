  		...
  		<form class="form-signin" id="searchList" name="searchList" method="post" action="searchList.do">
      		<div class="box box-default">
        		<div class="box-header with-border">
          			<h3 class="box-title"><spring:message code="common.wd.회원관리" /> > <spring:message code="common.wd.회원리스트" /></h3>
        		</div>
        		<!-- /.box-header -->
        		<div class="box-body">
          			<div class="row">
          		...
          		<div class="box">
            		...
            		<div class="box-body">
              			<table id="example2" class="table table-bordered table-hover">
                			<thead>
                				<tr>
                  					<th width="10%"><spring:message code="common.wd.회원번호" /></th>
                  					<th width="10%"><spring:message code="common.wd.회원구분" /></th>
                  					<th width="10%"><spring:message code="common.wd.회원아이디" /></th>
                  					<th><spring:message code="common.wd.회원명" /></th>
                  					<th><spring:message code="common.wd.닉네임" /></th>
                  					<th><spring:message code="common.wd.포인트" /></th>
                			...
                			<tbody>
                				<c:forEach items="${pageHelper.list}" var="list">
	                				<tr>
	                  					...
	                  					<td><a href="updateForm.do?curr_page=${pageHelper.currPage}&member_id=${list.member_id}">${list.member_id}</a></td>
	                  					<td>${list.member_name}</td>
	                  					<td>${list.member_nick_name}</td>
